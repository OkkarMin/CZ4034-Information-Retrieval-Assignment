...
def main():
    ...
    bearer_token = topsecret["bearerToken"] # bearer_token = os.environ.get("BEARER_TOKEN")
    headers = create_headers(bearer_token)

    accountsList = ["Apple","Microsoft","Amazon","Google", "Facebook","riotgames","Samsung","SamsungMobile","nvidia","NVIDIAGeForce","Adobe", "Photoshop","Lightroom","creativecloud","AdobeCare","salesforce"]
    nameTag = "tableaupublic"
    firstRun = True
    ntoken = "0"
    json_response = {}
    url = create_url("to:"+nameTag,100) #remove the "to:" to search for hashtags instead
    numResults = 0
    numPages = 10
    ...
    print("Total No. Results (Max 1000): "+str(numResults) + " for #"+nameTag)
